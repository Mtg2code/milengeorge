    ...
    <section className='relative w-full h-screen mx-auto mt-5'>
      ...
      <div className={`${styles.paddingX}  absolute inset-0  top-[120px] max-w-7xl mx-auto flex flex-row items-start gap5 `} >
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} text-white mt-4 mx-5`}> I am a student who likes to build websites<br className='sm:block hidden'/> and other intresting projects.
          </p>
        </div>
      </div>
      <ComputersCanvas/>
